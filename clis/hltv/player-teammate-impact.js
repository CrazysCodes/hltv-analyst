...
cli({
  ...
  access: 'read',
  example: 'opencli hltv player-teammate-impact --playerA 3741/niko --playerB 19230/m0nesy --limit 50 -f json',
  domain: 'www.hltv.org',
  strategy: Strategy.UI,
  browser: true,
  navigateBefore: false,
  args: [
    { name: 'playerA', type: 'string', required: true, help: 'Primary player ref' },
    { name: 'playerB', type: 'string', required: true, help: 'Teammate player ref' },
