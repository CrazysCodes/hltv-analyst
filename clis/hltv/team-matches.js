...
cli({
  ...
  access: 'read',
  example: 'opencli hltv team-matches --team 6667/falcons --limit 10 -f json',
  domain: 'www.hltv.org',
  strategy: Strategy.UI,
  browser: true,
  navigateBefore: false,
  args: [
    { name: 'team', type: 'string', required: true, help: 'Team ref: 6667/falcons, team URL, or stats team URL' },
