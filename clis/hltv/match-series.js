...
cli({
  ...
  access: 'read',
  example: 'opencli hltv match-series --match https://www.hltv.org/stats/matches/126993/spirit-vs-falcons -f json',
  domain: 'www.hltv.org',
  strategy: Strategy.UI,
  browser: true,
  navigateBefore: false,
  args: [
    { name: 'match', type: 'string', required: true, help: 'HLTV match, stats series, or mapstats URL' },
  ],
