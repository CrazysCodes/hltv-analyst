...
cli({
  ...
  access: 'read',
  example: 'opencli hltv match-map --match "https://www.hltv.org/stats/matches/mapstatsid/231594/falcons-vs-natus-vincere" -f json',
  domain: 'www.hltv.org',
  strategy: Strategy.UI,
  browser: true,
  navigateBefore: false,
  args: [
    { name: 'match', type: 'string', required: true, help: 'Full HLTV /stats/matches/mapstatsid/:id/:slug URL from player-matches' },
  ],
