...
cli({
  ...
  access: 'read',
  example: 'opencli hltv team-map-pool --team 11283/falcons -f json',
  domain: 'www.hltv.org',
  strategy: Strategy.UI,
  browser: true,
  navigateBefore: false,
  args: [
    { name: 'team', type: 'string', required: true, help: 'Team ref: 11283/falcons, team URL, or stats team URL' },
  ],
