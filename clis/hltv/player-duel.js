...
cli({
  ...
  access: 'read',
  example: 'opencli hltv player-duel --playerA 19230/m0nesy --playerB 3741/niko --match https://www.hltv.org/stats/matches/mapstatsid/231594/falcons-vs-natus-vincere -f json',
  domain: 'www.hltv.org',
  strategy: Strategy.UI,
  browser: true,
  navigateBefore: false,
  args: [
    { name: 'playerA', type: 'string', required: true, help: 'First player ref: 19230/m0nesy, player URL, or stats player URL' },
    { name: 'playerB', type: 'string', required: true, help: 'Second player ref: 3741/niko, player URL, or stats player URL' },
