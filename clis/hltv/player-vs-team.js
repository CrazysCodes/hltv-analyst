...
cli({
  ...
  access: 'read',
  example: 'opencli hltv player-vs-team --player 3741/niko --team 7020/spirit --limit 20 -f json',
  domain: 'www.hltv.org',
  ...
  args: [
    ...
    { name: 'team', type: 'string', required: true, help: 'Team ref: 7020/spirit, team URL, or stats team URL' },
